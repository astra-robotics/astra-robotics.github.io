...
class Footer extends React.Component {
    ...
    render() {
        return (
            <Container id="Footer" fluid={true} style={{zIndex: -10, paddingTop: "60px", margin: "auto"}}>
                <Row className='border-top' xs={1} sm={1} md={2} lg={4} style={{padding: "20px"}}>
                    <Col className='d-flex justify-content-center' style={{margin: "auto"}}>
                        <img src="/assets/images/astra_logo.svg" style={{width: "70%", minWidth: "200px"}} alt="Astra logo"/>
                    </Col>
